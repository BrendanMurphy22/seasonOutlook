...
<html>
    ...
    <body>
        ...
        <div id="show-stadium" class="content scaffold-show" role="main">
            ...
            <f:display bean="stadium" />
            <g:form resource="${this.stadium}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.stadium}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
